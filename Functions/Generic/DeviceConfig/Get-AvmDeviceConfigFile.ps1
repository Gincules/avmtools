function Get-AvmDeviceConfigFile {
    <#
        .SYNOPSIS
            Get FRITZ!Box configuration file
        .DESCRIPTION
            Get FRITZ!Box configuration file
        ...
        .EXAMPLE
            ...
            PS C:\> Get-AvmDeviceConfigFile -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Get-AvmDeviceConfigFile -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Get-AvmDeviceConfigFile -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Get-AvmDeviceConfigFile -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
...
"@ -f $ConfigPassword.GetNetworkCredential().Password, $ConfigFileUrl
    ...
    Process {
        $splatParameters = @{
            ...
            XmlResponse = "X_AVM-DE_GetConfigFileResponse"
        }

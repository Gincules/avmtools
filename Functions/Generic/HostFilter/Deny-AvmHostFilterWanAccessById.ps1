function Deny-AvmHostFilterWanAccessById {
    <#
        ...
        .EXAMPLE
            ...
            PS C:\> Deny-AvmHostFilterWanAccessById -RemoteAccess -Url "https://myfritzaddress12.myfritz.net" -Port 443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Deny-AvmHostFilterWanAccessById -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Deny-AvmHostFilterWanAccessById -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Deny-AvmHostFilterWanAccessById -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Deny-AvmHostFilterWanAccessById -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
    ...
    (
        ...
        [Parameter(Mandatory=$true)][ValidateNotNullOrEmpty()][int][bool]$Disallow
    )

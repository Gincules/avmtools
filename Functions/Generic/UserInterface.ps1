...
function Get-AvmUserInterfaceIntlConfig {
    <#
        .SYNOPSIS
            Wiki: https://github.com/Gincules/avmtools/wiki/Get-AvmUserInterfaceIntlConfig
        .DESCRIPTION
            Wiki: https://github.com/Gincules/avmtools/wiki/Get-AvmUserInterfaceIntlConfig
        .NOTES
            Author: Gincules
...
function Set-AvmUserInterfaceIntlConfig {
    <#
        .SYNOPSIS
            Wiki: https://github.com/Gincules/avmtools/wiki/Set-AvmUserInterfaceIntlConfig
        .DESCRIPTION
            Wiki: https://github.com/Gincules/avmtools/wiki/Set-AvmUserInterfaceIntlConfig
        .NOTES
            Author: Gincules

function Set-AvmFilelinkEntry {
    <#
        ...
        .EXAMPLE
            ...
            PS C:\> Set-AvmFilelinkEntry -RemoteAccess -Url "https://myfritzaddress12.myfritz.net" -Port 443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmFilelinkEntry -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmFilelinkEntry -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmFilelinkEntry -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmFilelinkEntry -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
...
"@ -f $FileId, $FileAccessLimit, $FileExpire
    ...
    Process {
        $splatParameters = @{
            ...
            XmlResponse = "SetFilelinkEntryResponse"
        }

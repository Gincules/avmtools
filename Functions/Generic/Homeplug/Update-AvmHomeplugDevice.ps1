function Update-AvmHomeplugDevice {
    <#
        ...
        .EXAMPLE
            ...
            PS C:\> Update-AvmHomeplugDevice -RemoteAccess -Url "https://myfritzaddress12.myfritz.net" -Port 443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Update-AvmHomeplugDevice -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Update-AvmHomeplugDevice -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Update-AvmHomeplugDevice -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Update-AvmHomeplugDevice -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
    ...
    Process {
        $splatParameters = @{
            ...
            XmlResponse = "DeviceDoUpdateResponse"
        }

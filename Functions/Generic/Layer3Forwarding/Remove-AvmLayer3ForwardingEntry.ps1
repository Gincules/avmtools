function Remove-AvmLayer3ForwardingEntry {
    <#
        .SYNOPSIS
        ...
        .EXAMPLE
            ...
            PS C:\> Remove-AvmLayer3ForwardingEntry -RemoteAccess -Url "https://myfritzaddress12.myfritz.net" -Port 443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Remove-AvmLayer3ForwardingEntry -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Remove-AvmLayer3ForwardingEntry -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Remove-AvmLayer3ForwardingEntry -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Remove-AvmLayer3ForwardingEntry -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
...
"@ -f $DestIPAddress, $DestSubnetMask, $SourceIPAddress, $SourceSubnetMask
    ...
    Process {
        $splatParameters = @{
            ...
            XmlResponse = "DeleteForwardingEntryResponse"
        }

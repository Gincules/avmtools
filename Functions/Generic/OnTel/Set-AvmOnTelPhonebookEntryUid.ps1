function Set-AvmOnTelPhonebookEntryUid {
    <#
        ...
        .EXAMPLE
            ...
            PS C:\> Set-AvmOnTelPhonebookEntryUid -RemoteAccess -Url "https://myfritzaddress12.myfritz.net" -Port 443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmOnTelPhonebookEntryUid -Url "https://fritz.box" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmOnTelPhonebookEntryUid -Insecure -Url "http://fritz.box" -Port 49000 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmOnTelPhonebookEntryUid -Url "https://192.168.178.1" -Port 49443 -Credential $Credential
        .EXAMPLE
            PS C:\> [PSCredential]$Credential = Get-Credential
            PS C:\> Set-AvmOnTelPhonebookEntryUid -Insecure -Url "http://192.168.178.1" -Port 49000 -Credential $Credential
    #>
